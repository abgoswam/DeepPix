...
#		self.d_bn4 = ops.batch_norm(name='d_bn4')
		...
		self.g_bn0 = ops.my_batch_norm(name='g_bn0')
		self.g_bn1 = ops.my_batch_norm(name='g_bn1')
		self.g_bn2 = ops.my_batch_norm(name='g_bn2')
		self.g_bn3 = ops.my_batch_norm(name='g_bn3')

		self.d_bn1 = ops.my_batch_norm(name='d_bn1')
		self.d_bn2 = ops.my_batch_norm(name='d_bn2')
		self.d_bn3 = ops.my_batch_norm(name='d_bn3')
		self.d_bn4 = ops.my_batch_norm(name='d_bn4')
