...
#	d_optim_pre = tf.train.AdamOptimizer(args.learning_rate, beta1 = args.beta1)
	d_optim_pre = tf.train.GradientDescentOptimizer(args.learning_rate)
	print('inter-12')
	d_optim = d_optim_pre.minimize(loss['d_loss'])
	print('inter-22')
     
#	g_optim = tf.train.AdamOptimizer(args.learning_rate, beta1 = args.beta1).minimize(loss['g_loss'])
	g_optim = tf.train.GradientDescentOptimizer(args.learning_rate).minimize(loss['g_loss'])
